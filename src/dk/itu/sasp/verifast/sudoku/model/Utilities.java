...
public abstract class Utilities {
	// This class is a set of methods that perform common often used methods
	// from the Java Framework.
	// Unfortunately VeriFast doens't allow such method calls, so we abstract
	// from them by adding them to this class
